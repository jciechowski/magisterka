...
\\\indent Niech $H$ będzie planarnym grafem kubicznym z trójkątną ścianą zewnętrzną, w której wszystkie wierzchołki, poza zewnętrznymi, spełniają założenie, że wektory wychodzące z wierzchołków wzdłuż krawędzi rozpinają płaszczyznę\todo[inline]{Jak to wyjaśnić?}. Graf $H$ posiada $k$ wierzchołków i $\frac{3k}{2}$ krawędzi.
...
\begin{biblist}
 ...
 \bibitem{appel} K. Appel i W. Haken, Every planar map is four colorable, Illinois J. Math. Volume 21, Issue 3 (1977), 429-490. 
\end{biblist}
\end{bibdiv}
