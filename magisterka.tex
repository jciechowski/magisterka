...
\title    {\hspace{0.8cm} Problem galerii sztuki \newline dla odcinków na płaszczyźnie}
...
\\\indent Niech $H$ będzie kubicznym grafem płaskim z trójkątną ścianą zewnętrzną, w której wszystkie wierzchołki, poza zewnętrznymi, spełniają założenie, że wektory wychodzące z wierzchołków wzdłuż krawędzi są liniowo niezależne \cite{topp} (każdy planarny graf prosty można przedstawić w taki sposób, że krawędzie grafu są reprezentowane jako odcinki proste \cite{fary}). Graf $H$ posiada $k$ wierzchołków i $\frac{3k}{2}$ krawędzi.
...
\begin{Twierdzenie} \cite{illumination}
 Dowolny zbiór $F$ składający się z $n$ rozłącznych odcinków możemy oświetlić przy użyciu co najwyżej $\ceil{\frac{2n}{3}}$ źródeł światła.
\end{Twierdzenie}
...
$(\ceil{\frac{n+1}{3}} + 2) + (n + 3-2(\ceil{\frac{n+1}{3}} + 2)) = n + 1-\ceil{\frac{n+1}{3}} \le \ceil{\frac{2n}{3}}$.
\end{proof}
...
Rozpatrzmy najpierw zbiór $F = \{L_1,\ldots,L_n\}$ odcinków takich, że ich rzut na oś OX tworzy rozłączny zbiór. Przez $\alpha_i$ oznaczmy nachylenie odcinka $L_i, \linebreak i = 1,\ldots,n$, w stosunku do osi OX.
...
Aby strzec całej siatki, przynajmniej jeden strażnik musi znajdować się w każdym korytarzu. Niech $G(P)$ będzie grafem przecięć siatki $P$, w którym każdy wierzchołek z grafu $G$ odpowiada maksymalnego odcinkowi z $P$, a dwa wierzchołki są połączone krawędzią wtedy i tylko wtedy, gdy odpowiadające im odcinki przecinają się.
 ...
 \begin{figure}[ht!]
   ...
   \caption{Graf przecięć siatki z rysunku \ref{fig:siatka 2d}. Skojarzenie oznaczono linią ciągłą.}
...
\\\indent Załóżmy teraz, że wszystkie krawędzie incydentne z wierzchołkami \linebreak $1,\ldots,i-1$ grafu $G$ zostały przypisane do ścieżek siatki $P$ oraz rozpatrzmy krawędź $\{i,j\}, i < j$. Przyjmujemy, że ścieżka z $v_i$ do $v_j$, dla $i < j$, wychodzi z $v_i$ dodatnią osią $+x$, $+y$ lub $+z$, a wchodzi do $v_j$ ujemną osią $-x$, $-y$ lub $-z$. Skoro stopień wierzchołka $i$ wynosi co najwyżej trzy, jeden z trzech kierunków $x$, $y$ lub $z$ w $(3i, 3i, 3i)$ nie zawiera ścieżki dotychczas skonstruowanej siatki $P$. Załóżmy, że kierunek $x$ jest wolny. W takim wypadku łączymy $v_i = (3i, 3i, 3i)$ z $v_j = (3j, 3j, 3j)$ trzema odcinkami:
\begin{itemize}
	\item $(3i, 3i, 3i) \rightarrow (3j, 3i, 3i)$;
	\item $(3j, 3i, 3i) \rightarrow (3j, 3j, 3i)$;
	\item $(3j, 3j, 3i) \rightarrow (3j, 3j, 3j)$.
\end{itemize}
Oczywiście powyższe odcinki nie mogą przecinać się z żadnymi już istniejącymi ścieżkami. Przykład takiego połączenia widać na rysunku \ref{fig:nowe sciezki} w przypadku, gdy wolny jest kierunek $x$, $y$ lub $z$.
\begin{figure}[ht!]
  \centering
  ...
  \caption{Nowo powstałe ścieżki w przypadku wolnych kierunków $x$, $y$ lub $z$.}
...
\begin{itemize}
 ...
 \item najkrótsza droga strażnika mobilnego \cite{watchmanroutes};
...
\newblock{{\em Discrete Applied Mathematics} 8, str. 1-12 (1984).}
 ...
 \newblock{{\em IEEE Transactions on Computers} 30, str. 910-914 (1981).}
 ...
 \newblock{Coverage with $k$-transmitters in the presence of obstacles.}
 \newblock{{\em Journal of Combinatorial Optimization} 25(2), str. 208-233 (2013). }
 ...
 \bibitem{watchmanroutes}
 A. \ Dumitrescu, J. \ Mitchell i P. \ Żyliński
 \newblock{Watchman routes for lines and line segments.}
 \newblock{{\em Computational Geometry} 47(4), str. 527-539 (2014).}
 ...
 \newblock{{\em Acta Scientiarum Mathematicarum} 11, str. 229–233 (1948).}
 ...
 \bibitem{guarding walls} 
  ...
  \newblock{{\em The Visual Computer} 15(6), str. 265-278 (1999).}
...
\newblock{{\em Computational geometry} 2(6), str. 309-334 (1993).}
 ...
 \bibitem{orourke}
 J. \ O'Rourke.
 \newblock{Art Gallery Theorems and Algorithms.}
 ...
 \newblock{Proceedings of the Twenty-First Annual Hawaii International Conference On System Sciences, str. 218-226 (1988).}
 ...
 \newblock{Elsevier Science, str. 973-1027 (2000).}
