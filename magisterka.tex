...
% wstęp
\introduction
Klasyczny problem galerii sztuki 
...
\begin{proof}
	...
	\end{center}
	Widać to na poniższym rysunku \ref{fig:drugi krok}.
	\begin{figure}[ht!]
	  \centering
